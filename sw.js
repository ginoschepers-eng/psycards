const CACHE='psycards-v32';
self.addEventListener('install',e=>{self.skipWaiting();e.waitUntil(caches.open(CACHE).then(c=>c.addAll(['./','./index.html','./manifest.json','./psycards-logo.png','./icon-192.png','./icon-512.png','./apple-touch-icon.png'])))});
